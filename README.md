This is a new Shared Collection (integration settgings) to be use in Cenit, named cenit-collection-basic.

Cenit is an open source social platform as a service for data and business integration.

# CenitCollectionBasic
...
Or install it yourself as:
    ...
    $ gem install cenit-collection-basic
...
% tree
.
├── cenit-collection-cenit-collection-basic.gemspec
├── Gemfile
├── .gitignore
├── .rspec
├── README.md
    ...
    └── cenit
        └── collection
            └── cenit-collection-basic
                 ...
                 └── build.rb
                 └── version.rb
            └── cenit-collection-basic.rb
└── spec
    └── cenit
        └── collection
            └── cenit-collection-basic_spec.rb
    └── spec_helper.rb
    └── support
        └── samples
```
...
1. Fork it ( https://github.com/[my-github-username]/cenit-collection-basic/fork )
